...
func buildPrPrompt(options prPromptOptions) string {
	return fmt.Sprintf(`You are a PR agent. Your job is to create a well-structured pull request from the completed work on this branch.
...
7. Wait for checks and report the final PR status.
